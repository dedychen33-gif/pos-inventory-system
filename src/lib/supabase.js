...
const SUPABASE_URL = (import.meta.env.VITE_SUPABASE_URL || 'YOUR_SUPABASE_URL').trim()
const SUPABASE_ANON_KEY = (import.meta.env.VITE_SUPABASE_ANON_KEY || 'YOUR_SUPABASE_ANON_KEY').trim()
